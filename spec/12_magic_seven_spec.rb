...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    context 'when the random number is 1 and previous step is 8' do
  ...
  describe '#play' do
    context 'when the random number is 20' do
      subject(:game_three) {described_class.new(20)}
    ...
    context 'when the random number is 19' do
      subject(:game_four) {described_class.new(19)}
      # remove the 'x' before running this test
      it 'will return 7' do
    ...
    context 'when the random number is 1' do
      subject(:game_five) {described_class.new(1)}
      # remove the 'x' before running this test
      it 'will return 7' do
